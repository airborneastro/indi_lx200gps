...
static std::unique_ptr<MyFocuserPro2_1> myFocuserPro2_1(new MyFocuserPro2_1());

MyFocuserPro2_1::MyFocuserPro2_1()
{
...
bool MyFocuserPro2_1::initProperties()
{
...
bool MyFocuserPro2_1::updateProperties()
{
    ...
    if (isConnected())
    {
        ...
        LOG_INFO("MyFocuserPro2_1 parameters updated, focuser ready for use.");
    }
    else
    {
...
bool MyFocuserPro2_1::Handshake()
{
    if (Ack())
    {
        LOG_INFO("MyFocuserPro2_1 is online. Getting focus parameters...");
    ...
    LOG_INFO(
        "Error retrieving data from MyFocuserPro2_1, please ensure MyFocuserPro2_1 controller is powered and the port is correct.");
    return false;
}

const char * MyFocuserPro2_1::getDefaultName()
{
    return "MyFocuserPro2_1";
}

bool MyFocuserPro2_1::Ack()
{
...
bool MyFocuserPro2_1::readCoilPowerState()
{
    char res[ML_RES] = {0};
...
bool MyFocuserPro2_1::readReverseDirection()
{
    char res[ML_RES] = {0};
...
bool MyFocuserPro2_1::readStepMode()
{
    char res[ML_RES] = {0};
...
bool MyFocuserPro2_1::readTemperature()
{
    char res[ML_RES] = {0};
...
bool MyFocuserPro2_1::readTempCompensateEnable()
{
    char res[ML_RES] = {0};
...
bool MyFocuserPro2_1::readPosition()
{
    char res[ML_RES] = {0};
...
bool MyFocuserPro2_1::readTemperatureCoefficient()
{
    char res[ML_RES] = {0};
...
bool MyFocuserPro2_1::readSpeed()
{
    char res[ML_RES] = {0};
...
bool MyFocuserPro2_1::readMaxPos()
{
    char res[ML_RES] = {0};
...
bool MyFocuserPro2_1::readBacklashInSteps()
{
    char res[ML_RES] = {0};
...
bool MyFocuserPro2_1::readBacklashInEnabled()
{
    char res[ML_RES] = {0};
...
bool MyFocuserPro2_1::readBacklashOutSteps()
{
    char res[ML_RES] = {0};
...
bool MyFocuserPro2_1::readBacklashOutEnabled()
{
    char res[ML_RES] = {0};
...
bool MyFocuserPro2_1::readDisplayVisible()
{
    char res[ML_RES] = {0};
...
bool MyFocuserPro2_1::setTemperatureCelsius()
{
    char cmd[ML_RES] = {0};
...
bool MyFocuserPro2_1::setTemperatureCoefficient(double coefficient)
{
    char cmd[ML_RES] = {0};
...
bool MyFocuserPro2_1::SyncFocuser(uint32_t ticks)
{
    char cmd[ML_RES] = {0};
...
bool MyFocuserPro2_1::MoveFocuser(uint32_t position)
{
    char cmd[ML_RES] = {0};
    if(isMoving())
    {
...
bool MyFocuserPro2_1::setBacklashInSteps(int16_t steps)
{
    char cmd[ML_RES] = {0};
...
bool MyFocuserPro2_1::setBacklashInEnabled(bool enabled)
{
    char cmd[ML_RES] = {0};
...
bool MyFocuserPro2_1::setBacklashOutSteps(int16_t steps)
{
    char cmd[ML_RES] = {0};
...
bool MyFocuserPro2_1::setBacklashOutEnabled(bool enabled)
{
    char cmd[ML_RES] = {0};
...
bool MyFocuserPro2_1::setCoilPowerState(CoilPower enable)
{
    char cmd[ML_RES] = {0};
...
bool MyFocuserPro2_1::ReverseFocuser(bool enable)
{
    char cmd[ML_RES] = {0};
...
bool MyFocuserPro2_1::setDisplayVisible(DisplayMode enable)
{
    char cmd[ML_RES] = {0};
...
bool MyFocuserPro2_1::setGotoHome()
{
    char cmd[ML_RES] = {0};
    if(isMoving())
    {
...
bool MyFocuserPro2_1::setStepMode(FocusStepMode smode)
{
    char cmd[ML_RES] = {0};
...
bool MyFocuserPro2_1::setSpeed(uint16_t speed)
{
    char cmd[ML_RES] = {0};
...
bool MyFocuserPro2_1::setTemperatureCompensation(bool enable)
{
    char cmd[ML_RES] = {0};
...
bool MyFocuserPro2_1::ISNewSwitch(const char * dev, const char * name, ISState * states, char * names[], int n)
{
...
bool MyFocuserPro2_1::ISNewNumber(const char * dev, const char * name, double values[], char * names[], int n)
{
    if (dev != nullptr && strcmp(dev, getDeviceName()) == 0)
    {
        // Temperature Settings
...
void MyFocuserPro2_1::getStartupValues()
{
    readMaxPos();
    readPosition();
    readTemperature();
...
bool MyFocuserPro2_1::SetFocuserSpeed(int speed)
{
    return setSpeed(speed);
}


bool MyFocuserPro2_1::SetFocuserMaxPosition(uint32_t maxPos)
{
    char cmd[ML_RES] = {0};
...
IPState MyFocuserPro2_1::MoveFocuser(FocusDirection dir, int speed, uint16_t duration)
{
    ...
    IEAddTimer(duration, &MyFocuserPro2_1::timedMoveHelper, this);
    return IPS_BUSY;
}

void MyFocuserPro2_1::timedMoveHelper(void * context)
{
    static_cast<MyFocuserPro2_1 *>(context)->timedMoveCallback();
}

void MyFocuserPro2_1::timedMoveCallback()
{
    AbortFocuser();
...
IPState MyFocuserPro2_1::MoveAbsFocuser(uint32_t targetTicks)
{
...
IPState MyFocuserPro2_1::MoveRelFocuser(FocusDirection dir, uint32_t ticks)
{
...
bool MyFocuserPro2_1::AbortFocuser()
{
    return sendCommand(":27#");
}

bool MyFocuserPro2_1::saveConfigItems(FILE * fp)
{
...
int MyFocuserPro2_1::msleep( long duration)
{
    struct timespec ts;
    int res;
...
void MyFocuserPro2_1::clearbufferonerror()
{
    bool rc;
    char res[ML_RES] = {0};
    int nbytes_read = 0;
...
bool MyFocuserPro2_1::sendCommand(const char * cmd, char * res)
{
    int nbytes_written = 0, nbytes_read = 0, rc = -1;
