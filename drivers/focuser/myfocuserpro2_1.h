...
class MyFocuserPro2_1 : public INDI::Focuser
{
    public:
        MyFocuserPro2_1();
        virtual ~MyFocuserPro2_1() override = default;
    ...
    private:
        bool Ack();
        /**
         * @brief sendCommand Send a string command to MyFocuserPro2_1.
